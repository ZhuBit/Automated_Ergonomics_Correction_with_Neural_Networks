...
class RULA():
    ...
    def compute_scores(self):
        ...
        for i, frame in enumerate(angles):
            ...
            #angles used for evaluation
            shoulder_angels.append(max_shoulder)
            # A. Check Abduction
            ...
            # angles used form evaluation
            trunk_angels.append(frame[8])
        ...
        return score_total, shoulder_angels, trunk_angels, knee_angles
